...
- [ ] **Admin-configurable accent color** — a color picker in Settings, same pattern as the scoring-formula fields, so a team can make it "theirs" without touching CSS.
